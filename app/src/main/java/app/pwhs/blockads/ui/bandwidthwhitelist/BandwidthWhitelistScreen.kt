...
/**
 * Lets the user pick apps that should be EXEMPT from the global
 * bandwidth limiter (Settings → Protection → Bant Genişliği Sınırı) —
 * a "don't throttle these" whitelist. Structurally identical to
 * [app.pwhs.blockads.ui.whitelist.AppWhitelistScreen] (same search +
 * tabs + filter chips + list), just backed by a different preference
 * and a different meaning for the toggle.
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun BandwidthWhitelistScreen(
    modifier: Modifier = Modifier,
    viewModel: BandwidthWhitelistViewModel = koinViewModel(),
    onNavigateBack: () -> Unit = { }
) {
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = {
                    Column {
                        Text(
                            stringResource(R.string.bandwidth_whitelist_title),
                            fontWeight = FontWeight.Bold
                        )
                        Text(
                            stringResource(R.string.bandwidth_whitelist_count, whitelistedApps.size),
        ...
        Column(
            ...
            Text(
                stringResource(R.string.bandwidth_whitelist_hint),
                style = MaterialTheme.typography.bodySmall,
                color = TextSecondary,
            ...
            Row(
                ...
                FilterChip(
                    ...
                    label = { Text(stringResource(R.string.bandwidth_whitelist_filter_exempt)) },
                    colors = FilterChipDefaults.filterChipColors(
                        selectedContainerColor = MaterialTheme.colorScheme.primary,
                        selectedLabelColor = MaterialTheme.colorScheme.onPrimary
                    )
                ...
                FilterChip(
                    ...
                    label = { Text(stringResource(R.string.bandwidth_whitelist_filter_throttled)) },
                    colors = FilterChipDefaults.filterChipColors(
                        selectedContainerColor = MaterialTheme.colorScheme.primary,
                        selectedLabelColor = MaterialTheme.colorScheme.onPrimary
                    )
